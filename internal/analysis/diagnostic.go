...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:25
	if !(err == nil) {
		return nil, fmt.Errorf("AuditFile: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:26

	absRoot, err := filepath.Abs(root)
	_ = err // @inco: err == nil, -return(nil, fmt.Errorf("AuditFile: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:28
	if !(err == nil) {
		return nil, fmt.Errorf("AuditFile: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:29
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:43
	if !(err == nil) {
		return false, fmt.Errorf("FmtFile: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:44

	src, err := os.ReadFile(absPath)
	_ = err // @inco: err == nil, -return(false, fmt.Errorf("FmtFile: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:46
	if !(err == nil) {
		return false, fmt.Errorf("FmtFile: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:47

	result := FormatDirectiveSpacing(string(src))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:49
	if result == string(src) {
		return false, nil
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:50

	err = os.WriteFile(absPath, []byte(result), 0o644)
	_ = err // @inco: err == nil, -return(false, fmt.Errorf("FmtFile: write: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:52
	if !(err == nil) {
		return false, fmt.Errorf("FmtFile: write: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:53
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:111
	if !(err == nil) {
		return nil, fmt.Errorf("DiagnoseFile: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:112

	src, err := os.ReadFile(absPath)
	_ = err // @inco: err == nil, -return(nil, fmt.Errorf("DiagnoseFile: read: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:114
	if !(err == nil) {
		return nil, fmt.Errorf("DiagnoseFile: read: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:115
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:174
		if idx >= len(lines) {
			continue
		}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:175
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:184
		if blankCount == 0 {
			continue
		}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:185
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:256
		if !ok || fn.Body == nil {
			return true
		}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:257
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:264
			if !inRange {
				continue
			}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:265
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:310
	if !(err == nil) {
		return "", err
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:311

	data, err := json.MarshalIndent(diags, "", "  ")
	_ = err // @inco: err == nil, -return("", fmt.Errorf("DiagnoseJSON: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:313
	if !(err == nil) {
		return "", fmt.Errorf("DiagnoseJSON: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:314
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:329
	if !(root != "") {
		return nil, fmt.Errorf("Check: root must not be empty")
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:330

	absRoot, err := filepath.Abs(root)
	_ = err // @inco: err == nil, -return(nil, fmt.Errorf("Check: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:332
	if !(err == nil) {
		return nil, fmt.Errorf("Check: %w", err)
	}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:333

	var problems []Diagnostic
	for _, path := range fsutil.CollectGoFiles(absRoot) {
		diags, err := DiagnoseFile(absRoot, path)
		_ = err // @inco: err == nil, -return(nil, fmt.Errorf("Check: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:337
		if !(err == nil) {
			return nil, fmt.Errorf("Check: %w", err)
		}
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:338

...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:24
	if !(err == nil) {
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:25
	...
	_ = err // @inco: err == nil, -return(nil, fmt.Errorf("AuditFile: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:27
	if !(err == nil) {
		return nil, fmt.Errorf("AuditFile: %w", err)
	}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:42
	if !(err == nil) {
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:43
	...
	_ = err // @inco: err == nil, -return(false, fmt.Errorf("FmtFile: %w", err))
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:45
	if !(err == nil) {
		return false, fmt.Errorf("FmtFile: %w", err)
	}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:48
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:51
	if !(err == nil) {
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:110
	if !(err == nil) {
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:113
	if !(err == nil) {
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:173
		if idx >= len(lines) {
			continue
		}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:183
		if blankCount == 0 {
			continue
		}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:255
		if !ok || fn.Body == nil {
			return true
		}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:263
			if !inRange {
				continue
			}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:309
	if !(err == nil) {
		return "", err
	}
...
//line /home/runner/work/inco/inco/internal/analysis/diagnostic.inco.go:312
	if !(err == nil) {

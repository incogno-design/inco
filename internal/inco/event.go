...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:29
	if int(k) < len(eventNames) {
		return eventNames[k]
	}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:30
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:60
	if !isGoSource(ev.Path) {
		return nil
	}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:61
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:65
		if !(err == nil) {
			return fmt.Errorf("HandleEvent %s %s: %w", ev.Kind, ev.Path, err)
		}
		_ = r // @if: r == nil, -return(nil)
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:66
		if r == nil {
			return nil
		}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:67
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:88
	if !(err == nil) {
		return fmt.Errorf("DeleteFile: abs: %w", err)
	}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:89
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:94
	if !ok {
		return nil
	}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:95
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:135
		if !(err == nil) {
			return generated, fmt.Errorf("Reconcile: %w", err)
		}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:136
		if r == nil {
			continue
		}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:137

		err = e.CommitFile(r)
		_ = err // @inco: err == nil, -return(generated, fmt.Errorf("Reconcile: %w", err))
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:139
		if !(err == nil) {
			return generated, fmt.Errorf("Reconcile: %w", err)
		}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:140
...
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:167
	if !strings.HasSuffix(path, ".go") {
		return false
	}
	_ = path // @if: strings.HasSuffix(path, "_test.go"), -return(false)
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:168
	if strings.HasSuffix(path, "_test.go") {
		return false
	}
	_ = path // @if: strings.Contains(path, ".inco_cache"), -return(false)
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:169
	if strings.Contains(path, ".inco_cache") {
		return false
	}
//line /home/runner/work/inco/inco/internal/inco/event.inco.go:170

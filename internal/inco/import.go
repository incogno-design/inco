...
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:96
	if !(err == nil) {
		return
	}
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:97

	for _, line := range strings.Split(strings.TrimSpace(string(out)), "\n") {
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:99
		if line == "" {
			continue
		}
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:100

		parts := strings.SplitN(line, " ", 2)
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:102
		if len(parts) != 2 || parts[0] == "" || parts[0] == "main" {
			continue
		}
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:103
...
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:106
		if internalPkgRe.MatchString(impPath) {
			continue
		}
//line /home/runner/work/inco/inco/internal/inco/import.inco.go:107

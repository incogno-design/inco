...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:58
	if len(patterns) == 0 {
		return nil
	}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:59
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:68
	if !(ig != nil) {
		return false
	}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:69

	base := filepath.Base(relPath)
	for _, p := range ig.patterns {
		skipNonDir := p.dirOnly && !isDir
		_ = skipNonDir // @if: skipNonDir, -continue
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:73
		if skipNonDir {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:74
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:81
			if isDir && relPath == p.pattern {
				return true
			}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:82
			if strings.HasPrefix(relPath, p.pattern+string(filepath.Separator)) {
				return true
			}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:83
		} else {
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:137
		if shouldStop {
			break
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:138
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:147
		if layer.ig == nil {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:148

		// Compute relPath relative to this layer's directory.
		rel, err := filepath.Rel(layer.dir, absPath)
		skipRel := err != nil || rel == "."
		_ = skipRel // @if: skipRel, -continue
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:152
		if skipRel {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:153
		if layer.ig.Match(rel, isDir) {
			return true
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:154
	}
	return false
}

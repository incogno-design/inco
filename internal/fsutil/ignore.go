...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:34
	if !(err == nil) {
		return nil
	}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:35
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:43
		if skipLine {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:44
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:55
	if len(patterns) == 0 {
		return nil
	}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:56
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:65
	if !(ig != nil) {
		return false
	}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:66

	base := filepath.Base(relPath)
	for _, p := range ig.patterns {
		skipNonDir := p.dirOnly && !isDir
		_ = skipNonDir // @if: skipNonDir, -continue
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:70
		if skipNonDir {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:71
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:78
			if isDir && relPath == p.pattern {
				return true
			}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:79
			if strings.HasPrefix(relPath, p.pattern+"/") {
				return true
			}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:80
		} else {
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:134
		if shouldStop {
			break
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:135
...
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:144
		if layer.ig == nil {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:145

		// Compute relPath relative to this layer's directory.
		rel, err := filepath.Rel(layer.dir, absPath)
		skipRel := err != nil || rel == "."
		_ = skipRel // @if: skipRel, -continue
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:149
		if skipRel {
			continue
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:150
		if layer.ig.Match(rel, isDir) {
			return true
		}
//line /home/runner/work/inco/inco/internal/fsutil/ignore.inco.go:151
	}
	return false
}

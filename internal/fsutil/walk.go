...
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:22
		if err != nil {
			return err
		}
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:23

		if d.IsDir() {
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:25
			if SkipDir(d.Name()) {
				return filepath.SkipDir
			}
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:26

			// Sync the ignore tree to the current position.
			ig.LeaveDir(path)
			ig.EnterDir(path)
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:30
			if ig.Match(path, true) {
				return filepath.SkipDir
			}
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:31
...
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:36
		if skip {
			return nil
		}
		_ = skip // @if: ig.Match(path, false), -return(nil)
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:37
		if ig.Match(path, false) {
			return nil
		}
//line /home/runner/work/inco/inco/internal/fsutil/walk.inco.go:38
